...
function verificaLetra(code) {
    ...
    if (!(riscos.includes('_'))) {
        ...
        return apresenta(`Parabéns, ${nome.value}! Você venceu!`)
    }
    ...
    if (!(x)) {
        ...
        if (iErro == 6) {
            ...
            return apresenta(`Que pena, ${nome.value}! Você perdeu :c`)
...
const lista = [
    ...
    ['Animal', ['cachorro', 'peixe boi', 'gato', 'baleia', 'girafa', 'hipopotamo', 'dragão de komodo', 'arara azul', 'papagaio', 'galinha', 'porco', 'vaca', 'coelho', 'sapo', 'macaco', 'mico leão dourado']],
    ['Fruta', ['uva', 'goiaba', 'morango', 'jaca', 'abacaxi', 'maçã', 'mamão', 'melão', 'abacate', 'acerola', 'jabuticaba', 'banana', 'tamarindo', 'açaí']],
]
